    ...
    <footer>
      ...
      <transition name="fade" mode="out-in">
        <div v-if="chatStart && !isRecording">
          ...
          <button class="start-typing btn" @click="startTyping()">
           <font-awesome-icon icon="keyboard" class="micro-icon"/>
          </button>
        </div>
      </transition>
      <transition name="fade" mode="out-in">
  ...
  export default {
    ...
    methods: {
      ...
      startTyping()
      {
        this.user_email = prompt("enter_text") 
...
#app footer {
  ...
  .start-typing {
    ...
    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#bb85d8", endColorstr="#7b01bc", GradientType=1);
  }
	.start-button {
		font-size: 11pt;
		color: #fff;
